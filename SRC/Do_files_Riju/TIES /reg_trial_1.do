...
outreg2 using results_full.doc, replace word
twoway (line fitted_values index_env), name(Graph_20years, replace)
graph export "DOC/images/Stata/graphfull.png", as(png) name("Graph_20years")

xtreg std_NTL index_env sq_index, fe vce(r) // For 20 years
predict fit_values, xb
outreg2 using results_full.doc, append word
twoway (line fit_values index_env), name(Graph_2, replace)
graph export "DOC/images/Stata/graph_full.png", as(png) name("Graph_2")
...
graph export "DOC/images/Stata/graphM1_3.png", as(png) name("Graph_M1_3")
...
graph export "DOC/images/Stata/graphM1_4.png", as(png) name("Graph_M1_4")
...
graph export "DOC/images/Stata/graphM1_5.png", as(png) name("Graph_M1_5")
...
graph export "DOC/images/Stata/graphM1_6.png", as(png) name("Graph_M1_6")
...
graph export "DOC/images/Stata/graphM2_3.png", as(png) name("Graph_M2_3")
...
graph export "DOC/images/Stata/graphM2_4.png", as(png) name("Graph_M2_4")
...
graph export "DOC/images/Stata/graphM2_5.png", as(png) name("Graph_M2_5") 
...
graph export "DOC/images/Stata/graphM2_6.png", as(png) name("Graph_M2_6")
...
graph export "DOC/images/Stata/graphM2_7.png", as(png) name("Graph_M2_7")
...
graph export "DOC/images/Stata/graphM2_8.png", as(png) name("Graph_M2_8")
...
graph export "DOC/images/Stata/graphM3_3.png", as(png) name("Graph_M3_3")
...
graph export "DOC/images/Stata/graphM3_4.png", as(png) name("Graph_M3_4")
