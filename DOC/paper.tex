...
\author{Ritwiz Sarma\thanks{Corresponding author. Email: ge23ritwiz@mse.ac.in. This is a preliminary draft for the 59th Conference of the Indian Econometric Society. Do not cite.}\\\small~Madras School of Economics \and Riju Garg\\\small~Madras School of Economics} % Riju can add acknowledgements and contact details here.
% \predate{Latest version available \href{www.facebook.com}{here}\\[1cm]}
\date{Original version: January 14, 2025\\This version: \today}
...
\begin{table}[h]
    ...
    \hline
    \multicolumn{1}{c}{\textbf{}} & \multicolumn{1}{c}{\textbf{Coef.}} & \multicolumn{1}{c}{\textbf{Rob. Std. Err.}} & \multicolumn{1}{c}{\textbf{t}} & \textbf{P\textgreater{}t} \\ \hline
...
% \input{tables/reg_outp_mod1_stdized_epoch1.tex}

For both sets of coefficients, we provide heteroskedasticity-robust standard errors using the \textcite{white1980} estimator. These coefficients remain significant while clustering at the \textit{shrid} level. 
