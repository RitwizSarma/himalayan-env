...
\institute{Madras School of Economics\\[3mm]Presented at the 59th Annual Conference of the Indian Econometric Society.}
\begin{document}
    \maketitle
...
%fix this
    ...
    \section{Data}
    \begin{frame}{Dataset Construction} % explain what shrid is
        \begin{description}
            \item[Shrid] Usually single village/town, can be aggregation if merged/separated between 1990-2013.
